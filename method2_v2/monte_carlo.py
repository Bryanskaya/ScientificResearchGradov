...
from numba import njit, prange, int_, bool_, optional, types, jit
...
# @njit((int_,int_,optional(types.float64[:])))
@njit #((int_,int_,types.float64[:, :]))
def process(iStart, jStart, matrU):
    u = 0
